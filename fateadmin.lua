...
game:GetService("StarterGui"):SetCore("SendNotification", { 
	Title = "Update!";
	Text = "NTG Admin Has detected an update!";
...
game:GetService("StarterGui"):SetCore("SendNotification", { 
	Title = "Check F9!";
	Text = "We're making sure everything is working! Just press F9 to see if it says "NTG ADMIN HAS EXECUTED PROPERLY." Thanks!";
	Icon = "rbxthumb://type=Asset&id=5107182114&w=150&h=150"})
Duration = 16;

wait(1)

print("NTG Admin has executed, properly.")
